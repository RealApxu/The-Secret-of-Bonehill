...
~ THEN EXTERN ~_%GARRICK_JOINED%~ FABGAR1
END
...
~ THEN BEGIN 14
  ...
  IF ~IfValidForPartyDialogue("GARRICK")
~ THEN EXTERN ~_%GARRICK_JOINED%~ FABGAR2
END
...
~ THEN EXTERN ~_%SHARTEEL_JOINED%~ FLIRTSHART
  IF ~IfValidForPartyDialogue("Branwen")
~ THEN EXTERN ~_%BRANWEN_JOINED%~ FLIRTBRANW
...
~ THEN EXTERN ~_%SAFANA_JOINED%~ FLIRTSAFAN
  IF ~IfValidForPartyDialogue("%IMOEN_DV%")
...
IF ~~ THEN BEGIN 22
  SAY @80
  IF ~~ THEN EXTERN ~_%MINSC_JOINED%~ FABMINGAR
END
...
~ THEN BEGIN 23
  SAY @81
  IF ~~ THEN EXTERN ~_%MINSC_JOINED%~ FABIOMIN
END
...
IF ~~ THEN BEGIN FABMINGAR 
  SAY @133 
  IF ~~ THEN EXTERN ~_%GARRICK_JOINED%~ FABMINGAR2
END
