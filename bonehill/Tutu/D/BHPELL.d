...
IF ~GlobalLT("BHQuestAccept","GLOBAL",1) AreaCheck("FW3402")~ THEN BEGIN 0
  SAY @1
  IF ~~ THEN REPLY @2 DO ~SetGlobal("BHQuestAccept","GLOBAL",1)
~ GOTO 1
  IF ~~ THEN REPLY @3 DO ~SetGlobal("BHQuestAccept","GLOBAL",1)
~ GOTO 7
END
...
IF ~~ THEN BEGIN 16
  SAY @28
  IF ~~ THEN REPLY @29 DO ~SetGlobal("BHQuestAccept","GLOBAL",4)
~ EXIT
  IF ~~ THEN REPLY @30 EXIT
  IF ~Global("BHQuestAccept","GLOBAL",4)
~ THEN REPLY @29 DO ~SetGlobal("BHQuestAccept","GLOBAL",5)
~ EXIT
END
...
~ THEN REPLY @32 DO ~IncrementGlobal("BHToldPelltarQuest","GLOBAL",1)
~ GOTO 18
  IF ~GlobalGT("BHGuardQuest","GLOBAL",1)
Global("BHToldPellRats","GLOBAL",0)
~ THEN REPLY @33 DO ~IncrementGlobal("BHToldPelltarQuest","GLOBAL",1)
~ GOTO 21
  IF ~Global("BHGnollQuest","GLOBAL",2)
Global("BHToldPellGnolls","GLOBAL",0)
~ THEN REPLY @34 DO ~IncrementGlobal("BHToldPelltarQuest","GLOBAL",1)
~ GOTO 22
  IF ~Global("BHToldPellBone","GLOBAL",0)
OR(2)
GlobalGT("BHBoneHillQuest","GLOBAL",1)
GlobalGT("BHRestenfordEnemies","GLOBAL",0)
~ THEN REPLY @35 DO ~IncrementGlobal("BHToldPelltarQuest","GLOBAL",1)
~ GOTO 28
  IF ~PartyHasItem("BHZAHRJ")
~ THEN REPLY @36 GOTO 24
...
IF ~~ THEN BEGIN 28
  ...
  IF ~Dead("BHTELV")
!Dead("BHWRAITH")
PartyHasItem("BHTELVBK")
~ THEN REPLY @55 GOTO 29
  IF ~!Dead("BHTELV")
Dead("BHWRAITH")
~ THEN REPLY @56 GOTO 30
  IF ~Dead("BHTELV")
Dead("BHWRAITH")
PartyHasItem("BHTELVBK")
~ THEN REPLY @57 GOTO 31
  IF ~OR(2)
GlobalLT("BHBoneHillQuest","GLOBAL",2)
GlobalLT("BHRestenfordEnemies","GLOBAL",1)
~ THEN REPLY @58 GOTO 45
END
...
~ THEN BEGIN 33
  SAY @64
  IF ~~ THEN REPLY @65 DO ~SetGlobal("BHHandQuestAccept","GLOBAL",2)
~ EXIT
END
...
~ THEN REPLY @67 DO ~SetGlobal("BHHandQuestAccept","GLOBAL",4)
SetGlobal("BHHandQuest","GLOBAL",1)
~ EXIT
  IF ~GlobalLT("BHToldPellBandit","GLOBAL",1)
~ THEN REPLY @68 DO ~SetGlobal("BHHandQuestAccept","GLOBAL",4)
SetGlobal("BHHandQuest","GLOBAL",1)
~ EXIT
END
...
~ THEN REPLY @71 GOTO 38
  IF ~OR(2)
GlobalLT("BHHandQuest","GLOBAL",3)
GlobalLT("BHHandGrave","GLOBAL",6)
~ THEN REPLY @72 GOTO 41
  IF ~Global("BHToldPellLighthouse","GLOBAL",0)
Dead("BHSIRIUS")
!PartyHasItem("BHSIRIUS")
~ THEN REPLY @73 DO ~SetGlobal("BHToldPellLighthouse","GLOBAL",1)
~ GOTO 42
  IF ~Global("BHToldPellLighthouse","GLOBAL",0)
Dead("BHSIRIUS")
PartyHasItem("BHSIRIUS")
~ THEN REPLY @74 DO ~TakePartyItem("BHSIRIUS")
...
IF ~~ THEN BEGIN 40
  ...
  IF ~!Dead("BHSirius")
Global("BHHandPellSawMap","GLOBAL",0)
~ THEN REPLY @88 DO ~SetGlobal("BHHandLightHouseOpen","GLOBAL",1)
SetGlobal("BHHandPellSawMap","GLOBAL",1)
~ EXIT
  IF ~Dead("BHSirius")
GlobalLT("BHToldPellLighthouse","GLOBAL",1)
~ THEN REPLY @89 DO ~SetGlobal("BHHandPellSawMap","GLOBAL",1)
SetGlobal("BHToldPellLighthouse","GLOBAL",1)
~ GOTO 42
  IF ~Global("BHToldPellLighthouse","GLOBAL",1)
Dead("BHSirius")
~ THEN REPLY @90 DO ~SetGlobal("BHHandPellSawMap","GLOBAL",1)
~ EXIT
END
...
IF ~~ THEN BEGIN 41
  ...
  IF ~Global("BHHandRavella","GLOBAL",1)
Global("BHTellPellRavella","GLOBAL",0)
~ THEN REPLY @92 DO ~SetGlobal("BHTellPellRavella","GLOBAL",1)
~ EXIT
END
...
~ THEN REPLY @94 GOTO 43
  IF ~GlobalLT("BHHandQuest","GLOBAL",3)
GlobalLT("BHHandGrave","GLOBAL",6)
~ THEN REPLY @95 DO ~SetGlobal("BHStayForMarauders","GLOBAL",1)
...
~ THEN REPLY @97 DO ~SetGlobal("BHStayForBomarc","GLOBAL",1)
~ EXIT
  IF ~GlobalLT("BHHandQuest","GLOBAL",3)
Global("BHHandGrave","GLOBAL",6)
GlobalLT("BHStayForMarauders","GLOBAL",1)
~ THEN REPLY @96 DO ~SetGlobal("BHStayForMarauders","GLOBAL",1)
~ EXIT
  IF ~GlobalGT("BHHandQuest","GLOBAL",2)
Global("BHHandGrave","GLOBAL",6)
GlobalLT("BHQuestAccept","GLOBAL",7)
!PartyHasItem("BHGHAND")
~ THEN REPLY @98 DO ~SetGlobal("BHToldPellBomarc","GLOBAL",1)
~ EXIT
END
...
~ THEN REPLY @135 GOTO 64
  IF ~PartyHasItem("BHPLOT04")
~ THEN REPLY @135 GOTO 90
END
...
PartyHasItem("BHNOTE1")
~ THEN REPLY @140 GOTO 67
  IF ~Global("BHQualReport","GLOBAL",1)
Dead("BHQUAL")
~ THEN REPLY @141 GOTO 70
  IF ~Global("BHToldPellAboutMayor","GLOBAL",0)
PartyHasItem("BHPLOT04")
~ THEN REPLY @142 GOTO 73
  IF ~!PartyHasItem("BHNOTE1")
!PartyHasItem("BHPLOT04")
~ THEN REPLY @143 GOTO 75
  IF ~Global("BHMayorGivesWaterQuest","GLOBAL",2)
!Dead("BHARRNESS")
~ THEN REPLY @144 GOTO 84
END

IF ~~ THEN BEGIN 67
  SAY @145
  IF ~Dead("BHQUAL")
~ THEN REPLY @146 GOTO 69
  IF ~!Dead("BHQUAL")
~ THEN REPLY @147 GOTO 68
END
...
IF ~~ THEN BEGIN 69
  SAY @149
  IF ~~ THEN REPLY @150 DO ~TakePartyItem("BHNOTE1")
~ GOTO 70
END
...
IF ~AreaCheck("FW2626") Global("BHToldOfDeath","GLOBAL",1)~ THEN BEGIN 76
  SAY @158
...
IF ~~ THEN BEGIN 77
  SAY @160
  IF ~~ THEN REPLY @161 DO ~SetGlobal("BHToldOfDeath","GLOBAL",2)
ClearAllActions()
StartCutSceneMode()
...
IF ~~ THEN BEGIN 80
  SAY @167
  IF ~~ THEN REPLY @168 DO ~SetGlobal("BHToldOfDeath","GLOBAL",2)
ClearAllActions()
StartCutSceneMode()
StartCutScene("BHCUTBAR")
~ EXIT
...
IF ~AreaCheck("FW2626") Global("BHToldOfDeath","GLOBAL",3)~ THEN BEGIN 81
  SAY @170
  IF ~~ THEN GOTO 82
END
...
IF ~~ THEN BEGIN 82
  SAY @171
  IF ~~ THEN REPLY @10 DO ~SetGlobal("BHToldOfDeath","GLOBAL",4)
~ EXIT
